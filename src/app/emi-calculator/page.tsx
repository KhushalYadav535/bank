  ...
  return (
    <main id="main-content" className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-crimson-dark via-charcoal to-crimson overflow-hidden">
        ...
        {/* Decorative elements */}
        <div className="absolute top-24 right-32 w-56 h-56 bg-gold/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-40 left-20 w-80 h-80 bg-crimson/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "0.7s" }} />
        ...
        <div className="container-premium relative z-10">
          ...
          >
            ...
            >
              <Link href="/loans" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-crimson font-semibold rounded-full hover:bg-white/90 transition-all hover:scale-105 hover:shadow-xl">
                Explore Loans <ArrowRight className="w-4 h-4" />
              </Link>
              <Link href="/contact" className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 text-white font-semibold rounded-full hover:bg-white/20 transition-all backdrop-blur-sm">
                <Calculator className="w-4 h-4" /> Apply Now
              </Link>
            </motion.div>
          </motion.div>
        </div>
