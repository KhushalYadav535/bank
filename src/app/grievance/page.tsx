  ...
  return (
    <main id="main-content" className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-crimson-dark via-crimson to-charcoal overflow-hidden">
        ...
        {/* Decorative elements */}
        <div className="absolute top-40 right-20 w-72 h-72 bg-gold/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-24 left-40 w-80 h-80 bg-crimson/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "0.8s" }} />
        ...
        <div className="container-premium relative z-10">
          ...
          >
            ...
            >
              ...
              <a href="mailto:grievance@mnsbankbhopal.com" className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 text-white font-semibold rounded-full hover:bg-white/20 transition-all backdrop-blur-sm">
                <Mail className="w-4 h-4" /> Email Grievance
              </a>
            </motion.div>
          </motion.div>
        </div>
