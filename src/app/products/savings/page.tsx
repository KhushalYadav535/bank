        ...
        <div className="container-premium relative z-10">
          ...
          >
            ...
            >
              ...
              <a href="#calculator" className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 text-white font-semibold rounded-full hover:bg-white/20 transition-all backdrop-blur-sm">
                <Calculator className="w-4 h-4" /> Calculate Interest
              </a>
            </motion.div>
          </motion.div>
        </div>
